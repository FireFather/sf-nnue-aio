...
namespace Eval {
	...
	namespace NNUE {
		...
		namespace Features {
			...
			// In order to make the execution time linear, the internal processing is performed in the reverse order of template arguments
			...
			public:
				...
				// List of timings for performing all calculations instead of difference calculation
