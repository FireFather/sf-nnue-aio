// Common header of learning class template of NNUE evaluation function
...
namespace Eval {
	...
	namespace NNUE {
		...
		// Ponanza constant used in relational expression between evaluation value and winning percentage
