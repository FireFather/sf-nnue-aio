	...
	namespace NNUE {
		...
		public:
			...
			void SendMessage(Message* message) {
				...
				// Tail is processed first for the purpose of simplifying implementation, but
		...
		// Learning: Layer that takes the sum of the output of multiple layers (when there is one template argument)
